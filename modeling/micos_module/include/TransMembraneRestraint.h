...
#ifndef IMPMICOS_TRANS_MEMBRANE_RESTRAINT_H  // Header guard
#define IMPMICOS_TRANS_MEMBRANE_RESTRAINT_H
...
class IMPMICOSEXPORT TransMembraneRestraint : public IMP::Restraint {
    ...
    public:
        TransMembraneRestraint(IMP::ParticlesTemp plist, double R,
        ...
        IMP_OBJECT_METHODS(TransMembraneRestraint);  //add the usual IMP object methods
