...
#ifndef IMPMICOS_Z_AXIAL_PROTEINWISE_RESTRAINT_H  // Header guard
#define IMPMICOS_Z_AXIAL_PROTEINWISE_RESTRAINT_H
...
class IMPMICOSEXPORT ZAxialProteinwiseRestraint : public IMP::Restraint {
    ...
    public:
        ZAxialProteinwiseRestraint(IMP::ParticlesTemp plist, double lower_bound, double upper_bound, double sigma);
