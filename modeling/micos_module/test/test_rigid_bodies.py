...
d1 = IMP.core.RigidBody.setup_particle(m, p1, IMP.algebra.ReferenceFrame3D())
d2 = IMP.core.RigidBody.setup_particle(m, p2, IMP.algebra.ReferenceFrame3D())
...
print(d1.get_coordinates(), d2.get_coordinates())

rm = IMP.core.RigidBody.get_is_setup(m, p2)
print(rm)
