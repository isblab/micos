...
def restoreCoreModels():
	...
	crdInfo = cPickle.loads(base64.b64decode(''))
	...
	vrmlInfo = {'subid': (2, 0, {}), 'display': (2, True, {}), 'id': (2, 1, {2: [1]}), 'vrmlString': ['.color white\n.cylinder 0 0 -200 0 0 200 12 open\n.color red\n.cylinder 0 0 -200 0 0 200 19 open\n', '.color white\n.cylinder 0 0 -200 0 0 200 12 open\n.color red\n.cylinder 0 0 -200 0 0 200 19 open\n'], 'name': (2, u'/home/muskaan/Documents/micos/modeling/two_cylinder_19,12.bild', {})}
...
u'Mo': ((0.329412, 0.709804, 0.709804), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (32.375229239464, 5.7478749752045, 4.5774791240692), 'fieldOfView': 29.495693998264, 'nearFar': (239.16461530432, -207.32566231249), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 4.5774791240692}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 64.455860932962, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': False, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [(None, [(0.94117647058824, 0.94117647058824, 0.94117647058824, 1), (0.74117647058824, 0.74117647058824, 0.74117647058824, 1), (0.38823529411765, 0.38823529411765, 0.38823529411765, 1)], 1), 1, 0, 0], 'depthCue': False, 'highlight': 0, 'scaleFactor': 0.50520648544392, 'angleDependentTransparency': False, 'backgroundMethod': 0}, 'viewerHL': 3, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': None}
...
def restoreRemainder():
	...
	windowSize = (1405, 703)
	xformMap = {0: (((0.34832968802431, -0.93735338707217, -0.005920826397337), 177.29810607667), (-8.7512742698379, 16.912278059887, 20.596651097423), True), 1: (((0.34832968802431, -0.93735338707217, -0.005920826397337), 177.29810607667), (-8.7512742698379, 16.912278059887, 20.596651097423), True), 160: (((0.34832968802431, -0.93735338707217, -0.005920826397337), 177.29810607667), (-8.7512742698379, 16.912278059887, 20.596651097423), True), 159: (((0.34832968802431, -0.93735338707217, -0.005920826397337), 177.29810607667), (-8.7512742698379, 16.912278059887, 20.596651097423), True)}
	fontInfo = {'face': ('Sans Serif', 'Normal', 16)}
	clipPlaneInfo = {}
	silhouettes = {0: True, 1: True, 160: True, 161: True, 159: True}
