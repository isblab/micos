...
for ((i=0; i<${#files[@]}; i++))
do
    python ~/projects/micos/github/scripts/analysis/plot_xlviol/get_color_by_min_distance.py "xl_viol/sampling/xl_violation_sampling_${files[$i]}" sampling_${files[$i]}
...
for ((i=0; i<${#files[@]}; i++))
do
    python ~/projects/micos/github/scripts/analysis/plot_xlviol/get_color_by_min_distance.py "xl_viol/evicalc/xl_violation_evicalc_${files[$i]}" evicalc_${files[$i]}
